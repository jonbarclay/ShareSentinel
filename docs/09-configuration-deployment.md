...
services:
  worker:
    ...
    environment:
      ...
      - AZURE_CERTIFICATE=/app/certs/JonPnPCert.pfx
      ...
      - SECURITY_EMAIL=${SECURITY_EMAIL:-security@uvu.edu}
    ...
    volumes:
      ...
      - ${AZURE_CERTIFICATE:-./JonPnPCert.pfx}:/app/certs/JonPnPCert.pfx:ro
    depends_on:
      redis:
...
AZURE_CERTIFICATE=./JonPnPCert.pfx
